...
class Inventario:
    ...
    def agregar_producto(self, codigo, plataforma, descripcion, cantidad, precio):
        ...
        self.cursor.execute("INSERT INTO productos VALUES (?, ?, ?, ?, ?)", (codigo, plataforma, descripcion, cantidad, precio))
    ...
    def modificar_producto(self, codigo, nueva_plataforma,  nueva_descripcion, nueva_cantidad, nuevo_precio):
        ...
        if producto:
            ...
            self.cursor.execute("UPDATE productos SET plataforma = ?, descripcion = ?, cantidad = ?, precio = ? WHERE codigo = ?",
                                (nueva_plataforma, nueva_descripcion, nueva_cantidad, nuevo_precio, codigo))
            self.conexion.commit()
...
def agregar_producto():
    ...
    return inventario.agregar_producto(codigo, plataforma, descripcion, cantidad, precio)
